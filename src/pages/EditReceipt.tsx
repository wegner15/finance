...
const EditReceipt: React.FC<EditReceiptProps> = ({ theme, path, companies, clients, projects, receipt }) => {
  const existingItems = JSON.parse(receipt.items || '[]');
  const items = existingItems.length > 0 ? existingItems : [{ description: '', quantity: 1, rate: 0, amount: 0 }];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">Edit Receipt</h1>
            <p className="text-lg text-gray-600 dark:text-gray-400">Update receipt details.</p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select
                      id="company_id"
                      name="company_id"
                      defaultValue={receipt.company_id}
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="client_id"
                      name="client_id"
                      defaultValue={receipt.client_id}
                      className="flex h-12 w-full rounded-lg border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 text-base ring-offset-background focus:border-green-500 dark:focus:border-green-400 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                      required
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="project_id"
                      name="project_id"
                      defaultValue={receipt.project_id || ''}
                      className="flex h-12 w-full rounded-lg border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 text-base ring-offset-background focus:border-green-500 dark:focus:border-green-400 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                   ...
                   <div className="space-y-2">
                     ...
                     <Input
                       ...
                       type="text"
                       defaultValue={receipt.reference_number || ''}
                    ...
                    <table className="w-full border-collapse border border-gray-200 dark:border-gray-600">
                      ...
                      <tbody>
                        {items.map((item: any, index: number) => (
                          <tr key={index} className={index % 2 === 0 ? 'bg-gray-50 dark:bg-gray-700' : 'bg-white dark:bg-gray-800'}>
                            ...
                            <td className="border border-gray-200 dark:border-gray-600 p-2 text-center text-gray-900 dark:text-gray-100 item-amount">
                              KSH {(item.amount || 0).toLocaleString('en', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                            </td>
                      ...
                      <tfoot>
                        <tr className="bg-gray-50 dark:bg-gray-700">
                          ...
                          <td className="border border-gray-200 dark:border-gray-600 p-2 text-center font-semibold total-amount">KSH {receipt.amount.toLocaleString('en', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</td>
