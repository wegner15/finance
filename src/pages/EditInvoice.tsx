...
const EditInvoice: React.FC<EditInvoiceProps> = ({ theme, path, companies, clients, projects, invoice }) => {
  return (
                ...
                <div className="space-y-4">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-200 dark:border-gray-600">
                      ...
                      <tbody>
                        {(() => {
                          const existingItems = JSON.parse(invoice.items || '[]');
                          return existingItems.length > 0 ? existingItems.map((item: any, index: number) => (
                      ...
                      <tfoot>
                        <tr className="bg-gray-50 dark:bg-gray-700">
                          ...
                          <td className="border border-gray-200 dark:border-gray-600 p-2 text-center font-semibold total-amount">KSH {invoice.amount ? invoice.amount.toLocaleString('en', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : '0.00'}</td>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={invoice.bank_name || ''}
                        className="h-12 text-base text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 rounded-lg"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={invoice.account_name || ''}
                        className="h-12 text-base text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 rounded-lg"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={invoice.account_number || ''}
                        className="h-12 text-base text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 rounded-lg"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={invoice.swift_code || ''}
                        className="h-12 text-base text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 rounded-lg"
                      />
                    </div>
                  </div>
      ...
      <script dangerouslySetInnerHTML={{
        __html: `
          document.addEventListener('DOMContentLoaded', function() {
            let rowCount = ${JSON.parse(invoice.items || '[]').length || 1};
